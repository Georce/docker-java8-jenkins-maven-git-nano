...
```
docker run -p 8080:8080 index.alauda.cn/georce/jenkins
```
...
```
docker run -p 8080:8080 -v /your/home:/var/jenkins_home index.alauda.cn/georce/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 -v /var/jenkins_home index.alauda.cn/georce/jenkins
```
...
```
docker run --name myjenkins -p 8080:8080 --env JAVA_OPTS=-Dhudson.footerURL=http://mycompany.com index.alauda.cn/georce/jenkins
```
